    ...
    >
      ...
      <div className="absolute bottom-0 left-0 right-0 z-20 flex flex-col gap-2 sm:gap-3 p-5 sm:p-8">
        ...
        <div style={{ marginTop: 6 }}>
          {isPreview ? (
            <span className="group/btn flex items-center font-body text-[11px] font-extrabold tracking-[0.25em] uppercase text-white cursor-default">
            ...
            <TransitionLink
              ...
              className="group/btn flex items-center font-body text-[11px] font-extrabold tracking-[0.25em] uppercase text-white no-underline"
            >
            ...
            <button
              ...
              className="group/btn flex items-center font-body text-[11px] font-extrabold tracking-[0.25em] uppercase text-white bg-transparent border-none p-0 cursor-pointer"
            >
