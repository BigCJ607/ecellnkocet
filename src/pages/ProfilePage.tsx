    ...
    <div style={{ minHeight: '100vh', backgroundColor: 'var(--color-bg)' }}>
      ...
      <div className="page-container" style={{ paddingTop: 'var(--space-md)', paddingBottom: 'var(--space-2xl)', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        <div style={{ maxWidth: 740, width: '100%', display: 'flex', flexDirection: 'column', gap: 24 }}>
          ...
          {/* Save success */}
          {saveSuccess && (
            <div style={{ padding: '12px 18px', backgroundColor: 'var(--color-white)', border: '1px solid var(--color-cream)', borderLeft: '3px solid var(--color-slate-blue)', display: 'flex', alignItems: 'center', gap: 10, animation: 'fadeUp 0.3s ease' }}>
              <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="var(--color-slate-blue)" strokeWidth="2.5"><polyline points="20 6 9 17 4 12"/></svg>
              <span style={{ fontFamily: 'var(--font-body)', fontSize: 13, color: 'var(--color-slate-blue)', fontWeight: 600 }}>Profile saved successfully.</span>
            </div>
          )}
            ...
            <div style={{ backgroundColor: 'var(--color-white)', border: '1px solid var(--color-cream)', overflow: 'hidden', animation: 'fadeUp 0.25s ease' }}>
              ...
              <div style={{ padding: '28px 32px', display: 'flex', flexDirection: 'column', gap: 24 }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: 16 }}>
                  ...
                  <div>
                    <SectionLabel>PNR / PRN</SectionLabel>
